...
function Trig_2__________uActions takes nothing returns nothing
    ...
    call SaveUnitHandle(YDHT, StringHash((I2S((GetHandleId((YDWEGetLocalVariableUnit("u"))))) )), StringHash(( "月神箭施放者" )), ( GetTriggerUnit())) // INLINED!!
    call SaveUnitHandle(YDHT, ((GetHandleId((YDWEGetLocalVariableUnit("u")))) ), ( 11 ), ( GetTriggerUnit())) // INLINED!!
...
function Trig_____________6Actions takes nothing returns nothing
    call SelectUnitForPlayerSingle((bj_lastAbilityCastingUnit), GetOwningPlayer((bj_lastAbilityCastingUnit))) // INLINED!!
    call DisplayTextToPlayer(Player(0), 0, 0, ( GetUnitName((bj_lastAbilityCastingUnit)) + " 释放结束冲锋技能" )) // INLINED!!
    // 让单位施法结束后不会乱跑
    call IssueImmediateOrderById((bj_lastAbilityCastingUnit), 851972) // INLINED!!
endfunction
//===========================================================================
...
function Trig_______7Actions takes nothing returns nothing
    call DisplayTextToPlayer(Player(0), 0, 0, ( GetUnitName((bj_lastAbilityCastingUnit)) + " 释放结束跳劈技能" )) // INLINED!!
endfunction
//===========================================================================
...
function Trig________________8Actions takes nothing returns nothing
    ...
    call YDWESetLocalVariableUnit("u" , (LoadUnitHandle(YDHT, ((GetHandleId(((bj_lastAbilityCastingUnit)))) ), ( 11)))) // INLINED!!
    call DisplayTextToPlayer(Player(0), 0, 0, ( GetUnitName((bj_lastAbilityTargetUnit)) + ( " 不小心被 " + ( GetUnitName(YDWEGetLocalVariableUnit("u")) + " 的月神箭颜射了！" ) ) )) // INLINED!!
endfunction
//===========================================================================
...
call ExecuteFunc("jasshelper__initstructs49453906")
...
function jasshelper__initstructs49453906 takes nothing returns nothing
