...
int _fastcall CC_PutTrigger_Count(DWORD This, DWORD cc_gui_type) {
    DWORD nItemCount, i;
    DWORD nItemClass;
    DWORD sum = 0;
...
void _fastcall CC_PutTrigger_PutExternProc(DWORD This, DWORD OutClass, char* name, DWORD cc_gui_type) {
    DWORD nItemCount, i;
    DWORD nItemClass;
...
void _fastcall CC_PutTrigger_ECA_ExternProc(DWORD This, DWORD OutClass) {
    char buff[260];
    char name[260];
